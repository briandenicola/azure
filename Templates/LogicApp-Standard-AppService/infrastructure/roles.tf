resource "azurerm_role_assignment" "storage_data_reader_managed_identity" {
...
resource "azurerm_role_assignment" "storage_queue_data_contributor_managed_identity" {
  scope                            = azurerm_storage_account.this.id
...
resource "azurerm_role_assignment" "storage_account_contributor_managed_identity" {
  scope                            = azurerm_storage_account.this.id
