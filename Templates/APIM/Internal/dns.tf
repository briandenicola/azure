...
resource "azurerm_private_dns_zone_virtual_network_link" "azure_api_net" {
...
resource "azurerm_private_dns_a_record" "azure_api_net" {
  name                = "${local.apim_name}.configuration.azure-api.net"
